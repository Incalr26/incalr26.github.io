import{t as e}from"../getRedirectHTML-C9SBJAfB.js";import{Logger as t,addViteSsrNoExternal as n,deepAssign as r,entries as i,fromEntries as a,getFullLocaleConfig as o,getModulePath as s,isArray as c,isFunction as l,isLinkAbsolute as u,isLinkHttp as d,isPlainObject as f,keys as p,normalizePath as m,removeEndingSlash as h,removeLeadingSlash as g}from"@vuepress/helper";import{createPage as _}from"vuepress/core";import{colors as v,fs as y,getDirname as b,path as x}from"vuepress/utils";const S=async e=>{e.pages.every(({path:e})=>e!==`/`)&&e.pages.push(await _(e,{path:`/`,frontmatter:{title:`Home`},content:`Redirecting to the correct locale...
`}))},C=`@vuepress/plugin-redirect`,w=new t(C),T=({config:e,defaultBehavior:t,defaultLocale:n,localeFallback:r},i,a)=>`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
