import { a as ShareServiceOptions } from "../../share-8T29xBgs.js";
...
declare const _default: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  tagGetter: {
    ...
    default: ({
      frontmatter
    }: PageData<Record<never, never>>) => unknown;
  }; /** Whether to display the share component inline */
  inline: BooleanConstructor; /** Use colorful icon */
