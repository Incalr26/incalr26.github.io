//#region src/presets/footerRunningTime.d.ts
/**
 * @param date - The date to calculate the running time
 * @param locales - The locales of running time, `:day`, `:hour`, `:minute`, `:second` will be
 ...
 */
declare const setupRunningTimeFooter: (date: string | Date, locales?: Record<string, string>, preserveContent?: boolean) => void;
//#endregion
