import { a as usePageAuthor, c as usePure, d as useThemeLocale, l as useData$1, u as useTheme } from "./PageInfo-BBtUekHB.js";
...
const isAllowedRootPath = (path) => path === "/" || /^\/?404(?:\.html)?$/u.test(path);
/**
...
const useNavbarLanguageDropdown = () => {
	...
	const isRootLocaleClean = computed(() => {
		...
		const localeRegExp = new RegExp(`^(?:${subLocales.map((locale) => locale.replaceAll(/[.*+?^${}()|[\]\\]/gu, String.raw`\$&`)).join("|")})`, "u");
...
//# sourceMappingURL=DropTransition-C13T467S.js.map