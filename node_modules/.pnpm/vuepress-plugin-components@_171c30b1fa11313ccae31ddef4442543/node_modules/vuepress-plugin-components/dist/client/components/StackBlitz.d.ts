...
import { UiThemeOption, UiViewOption } from "@stackblitz/sdk";
//#region src/client/components/StackBlitz.d.ts
declare const _default: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
   ...
   * 隐藏编辑器预览中的调试控制台
   */
  hideDevtools: BooleanConstructor; /** Height of the Terminal panel below the editor (as a percentage number). */
  terminalHeight: {
    type: (StringConstructor | NumberConstructor)[];
    default: number;
