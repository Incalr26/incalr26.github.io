...
import { a as ShareServiceOptions, i as ShareServiceConfig, n as ShareAction, o as ShareServiceVariableName, r as ShareService, t as BuiltInShareService } from "../share-8T29xBgs.js";
...
interface PDFLocaleData {
   ...
   * PDF hint text
   *
   * Only used if the browser does not support embedding PDF and no PDFJS URL is provided. [url]
   * will be replaced by actual PDF link. PDF 提示文字
   *
   * 只有在浏览器不支持嵌入 PDF 且没有提供 PDFJS URL 时才会使用 [url] 会被实际 PDF 链接替换
   */
  hint: string;
}
