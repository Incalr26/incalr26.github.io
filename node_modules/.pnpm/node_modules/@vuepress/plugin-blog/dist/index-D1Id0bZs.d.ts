...
//#endregion
//#region src/shared/internal.d.ts
/**
 ...
 *   }
 */
type CategoryLocaleMap = Record< /** Category name / 分类名称 */string, CategoryConfig>;
/**
 ...
 *   }
 */
type CategoryMap = Record< /** Locale path (e.g., `"/"`, `"/zh/"`) / 语言环境路径 */string, CategoryLocaleConfig>;
/**
 ...
 *   }
 */
type CategoriesMap = Record< /** Category key / 分类键名 */string, CategoryMap>;
/**
 ...
 *   }
 */
type TypeMap = Record< /** Locale path (e.g., `"/"`, `"/zh/"`) / 语言环境路径 */string, TypeLocaleConfig>;
/**
 ...
 *   }
 */
type TypesMap = Record< /** Type key / 类型键名 */string, TypeMap>;
//#endregion
export { CategoryMap as a, TypesMap as c, BlogPluginFrontmatter as d, BlogPluginTypeFrontmatter as f, CategoryLocaleMap as i, BlogCategoryFrontmatterOptions as l, CategoryConfig as n, TypeLocaleConfig as o, BlogTypeFrontmatterOptions as p, CategoryLocaleConfig as r, TypeMap as s, CategoriesMap as t, BlogPluginCategoryFrontmatter as u };
//# sourceMappingURL=index-D1Id0bZs.d.ts.map