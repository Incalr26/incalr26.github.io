...
interface CatalogPluginOptions {
   ...
   * 用作目录的组件名称。
   *
   * By default the plugin will register a `<Catalog />` component and use
   * interface. If you want to use your own component, you can set this option
...
//#endregion
//#region src/node/catalogPlugin.d.ts
/**
 * Catalog plugin
 *
 * 目录插件
...
//#endregion
export { CatalogPluginLocaleData, CatalogPluginOptions, catalogPlugin };
