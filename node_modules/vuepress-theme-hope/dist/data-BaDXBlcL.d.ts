import { d as AutoLinkOptions, f as NavItemOptions, l as SidebarOptions, m as AuthorInfo, p as Author, r as ThemeBasePageFrontmatter } from "./portfolio-FPgkMXUX.js";
import { a as BlogLocaleData, c as PaginationLocaleData, i as BlogLocaleConfig, l as PageInfoType, o as BlogLocaleOptions, r as ThemeHomePageFrontmatter } from "./blogHome-DJaoVOnc.js";
import { n as AppearanceLocaleData, t as AppearanceConfig } from "./appearance-CPtSZA01.js";
...
interface InfoOptions {
   ...
   * Extra i18n sites
   *
   * Key is the name of language, and value is the path of site, `:route` will be replaced by
   * current route
   *
   * 额外的多语言站点
   *
   * 键是语言的名称，值是站点的路径，`:route` 会被替换为当前路由
   */
...
//# sourceMappingURL=data-BaDXBlcL.d.ts.map