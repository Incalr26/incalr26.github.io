...
import { a as useDarkMode, n as _default$2, t as _default$6 } from "../NotFound-DhG2brD8.js";
...
declare const _default$4: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
   ...
   * 是否禁用侧边栏
   */
  noSidebar: BooleanConstructor; /** Whether disable toc */
...
declare const _default$1: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  group: BooleanConstructor; /** Whether to use appear */
